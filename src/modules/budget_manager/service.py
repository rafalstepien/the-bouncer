...
class DefaultBudgetManagerService(BaseBudgetManager):
    ...
    def __init__(
        ...
        self._zero_usage_per_pipeline: dict[str, int] = {p: 0 for p in self._pipeline_budget_max_capacity}
        self._current_pipeline_budget_usage: dict[str, int] = self._zero_usage_per_pipeline
    ...
    def _refill_tokens(self):
        ...
        if time_elapsed > self._token_refill_interval_seconds:
            ...
            self._current_pipeline_budget_usage = self._zero_usage_per_pipeline
